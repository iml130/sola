...
TEST_CASE("EstimamteTimeConsumption single function execution (neglect rotation cost, neglect "
  ...
  auto load_handling1 = AmrLoadHandlingUnit(1, 1, amr::AmrStaticAbility());
  auto load_handling2 = AmrLoadHandlingUnit(10, 10, amr::AmrStaticAbility());
  auto load_handling3 = AmrLoadHandlingUnit(2.5, 5, amr::AmrStaticAbility());
