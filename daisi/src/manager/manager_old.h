...
#ifndef DAISI_MANAGER_MANAGER_OLD_H_
#define DAISI_MANAGER_MANAGER_OLD_H_
...
template <typename ConcreteApplication> class ManagerOld {
public:
  explicit ManagerOld(const std::string &scenariofile_path) : parser_(scenariofile_path) {
